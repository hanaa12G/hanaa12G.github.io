...
// include: /tmp/tmptdtob50p.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/assets/data/flappy.data';
      var REMOTE_PACKAGE_BASE = '/assets/data/flappy.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_flappy.data');

      };
      Module['addRunDependency']('datafile_flappy.data');
    ...
    loadPackage({"files": [{"filename": "/resources/config.txt", "start": 0, "end": 119}], "remote_package_size": 119});

  })();

// end include: /tmp/tmptdtob50p.js
// include: /tmp/tmpeye5b4vb.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpeye5b4vb.js
// include: /tmp/tmpm4ejyb5s.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpm4ejyb5s.js
...
var ASM_CONSTS = {
  124688: () => { if (document.fullscreenElement) return 1; },  
 124734: () => { return document.getElementById('canvas').width; },  
 124786: () => { return parseInt(document.getElementById('canvas').style.width); },  
 124854: () => { document.exitFullscreen(); },  
 124881: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 124954: () => { if (document.fullscreenElement) return 1; },  
 125000: () => { return document.getElementById('canvas').width; },  
 125052: () => { return screen.width; },  
 125077: () => { document.exitFullscreen(); },  
 125104: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 125237: () => { return window.innerWidth; },  
 125263: () => { return window.innerHeight; },  
 125290: () => { if (document.fullscreenElement) return 1; },  
 125336: () => { return document.getElementById('canvas').width; },  
 125388: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125456: () => { if (document.fullscreenElement) return 1; },  
 125502: () => { return document.getElementById('canvas').width; },  
 125554: () => { return screen.width; },  
 125579: () => { return window.innerWidth; },  
 125605: () => { return window.innerHeight; },  
 125632: () => { if (document.fullscreenElement) return 1; },  
 125678: () => { return document.getElementById('canvas').width; },  
 125730: () => { return screen.width; },  
 125755: () => { document.exitFullscreen(); },  
 125782: () => { if (document.fullscreenElement) return 1; },  
 125828: () => { return document.getElementById('canvas').width; },  
 125880: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125948: () => { document.exitFullscreen(); },  
 125975: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 126033: () => { return screen.width; },  
 126058: () => { return screen.height; },  
 126084: () => { return window.screenX; },  
 126111: () => { return window.screenY; },  
 126138: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 126191: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 126262: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 126319: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 126575: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 126646: () => { if (document.fullscreenElement) return 1; },  
 126692: () => { return window.innerWidth; },  
 126718: () => { return window.innerHeight; },  
 126745: () => { if (document.pointerLockElement) return 1; }
};
